import speedtest
from fommbot import DEV_USERS, dispatcher
from fommbot.modules.disable import DisableAbleCommandHandler
from fommbot.modules.helper_funcs.chat_status import dev_plus
...
def speedtestxyz_callback(update: Update, context: CallbackContext):
    ...
    if query.from_user.id in DEV_USERS:
        ...
        query.answer("You are required to join @FULL_ON_MOJ_MASTIFonts for Android and iPhone  - www.fontskeyboard.com/share-now to use this command.")
