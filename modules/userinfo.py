...
from fommbot.__main__ import STATS, TOKEN, USER_INFO
import fommbot.modules.sql.userinfo_sql as sql
from fommbot.modules.disable import DisableAbleCommandHandler
from fommbot.modules.sql.global_bans_sql import is_user_gbanned
from fommbot.modules.sql.afk_sql import is_afk, check_afk_status
from fommbot.modules.sql.users_sql import get_user_num_chats
from fommbot.modules.helper_funcs.chat_status import sudo_plus
from fommbot.modules.helper_funcs.extraction import extract_user
from fommbot import telethn as FallenTelethonClient, TIGERS, DRAGONS, DEMONS
...
def info(update: Update, context: CallbackContext):
    ...
    if disaster_level_present:
        text += ' \n[<a href="https://t.me/LOVE_X_BIRDS/96962">ᴄʟɪᴄᴋ ʜᴇʀᴇ ᴛᴏ ᴋɴᴏᴡ ᴡʜᴀᴛ ɪs ᴅɪsᴀsᴛᴇʀ ʟᴇᴠᴇʟs.</a>]'.format(
            bot.username
        )
