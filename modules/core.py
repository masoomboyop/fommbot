...
from fommbot import OWNER_ID
from fommbot import TEMP_DOWNLOAD_DIRECTORY as path
from fommbot import TEMP_DOWNLOAD_DIRECTORY
from datetime import datetime
water = './fommbot/resources/fallen.jpg'
client = tbot
...
async def Prof(event):
    ...
    the_plugin_file = "./fommbot/modules/{}.py".format(input_str)
...
from fommbot.events import load_module
import asyncio
import os
from datetime import datetime
        ...
        try:
            downloaded_file_name = (
                await event.client.download_media(  # pylint:disable=E0602
                    ...
                    "fommbot/modules/",  # pylint:disable=E0602
                )
            )
...
from fommbot import telethn as tbot, OWNER_ID, DEV_USERS
from fommbot.events import register
import os
import asyncio
import os
...
from pathlib import Path
from fommbot import telethn as borg
