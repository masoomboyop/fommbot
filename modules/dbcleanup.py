...
import fommbot.modules.sql.global_bans_sql as gban_sql
import fommbot.modules.sql.users_sql as user_sql
from fommbot import DEV_USERS, OWNER_ID, dispatcher
