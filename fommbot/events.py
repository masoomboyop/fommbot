...
from fommbot import MONGO_DB_URI
...
def load_module(shortname):
    if shortname.startswith("__"):
        ...
        import importlib
        import fommbot.events

        path = Path(f"fommbot/modules/{shortname}.py")
        name = "fommbot.modules.{}".format(shortname)
        ...
        spec.loader.exec_module(mod)
        sys.modules["fommbot.modules." + shortname] = mod
        print("Successfully imported " + shortname)


path = "fommbot/modules/*.py"
