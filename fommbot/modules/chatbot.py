...
import html
import requests
import fommbot.modules.sql.chatbot_sql as sql
...
from fommbot.modules.helper_funcs.chat_status import user_admin, user_admin_no_reply
from fommbot import dispatcher, updater, SUPPORT_CHAT
from fommbot.modules.log_channel import gloggable
    ...
    if match:
        ...
        if is_kuki:
            ...
            update.effective_message.edit_text(
                "ᴋʀᴜᴛɪᴋᴀ ᴄʜᴀᴛʙᴏᴛ ᴅɪsᴀʙʟᴇᴅ ʙʏ {}.".format(mention_html(user.id, user.first_name)),
...
def kukiadd(update: Update, context: CallbackContext) -> str:
    ...
    if match:
        ...
        if is_kuki:
            ...
            update.effective_message.edit_text(
                "ᴋʀᴜᴛɪᴋᴀ ᴄʜᴀᴛʙᴏᴛ ᴇɴᴀʙʟᴇᴅ ʙʏ {}.".format(mention_html(user.id, user.first_name)),
                parse_mode=ParseMode.HTML,
            )
...
def list_all_chats(update: Update, context: CallbackContext):
    ...
    text = "<b>Krutika Enabled Chats</b>\n"
    for chat in chats:
        try:
